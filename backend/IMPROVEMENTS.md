...
This document outlines all improvements made to the service and controller layers of the JunkBox Backend API.
...
public ResponseEntity<Map<String, Object>> home() {
    ...
    response.put("message", "Welcome to JunkBox Backend API");
