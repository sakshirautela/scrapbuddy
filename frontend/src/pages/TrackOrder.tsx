...
import { getSupportSettings } from "../utils/supportSettings";
...
const TrackOrder = () => {
  ...
  const requestedOn = formatIndianDateTime(order?.createdDateTime || order?.pickupDate);
  const etaText = useMemo(() => {
    ...
    return `ETA: ${formatIndianDateTime(pickupDate)}`;
  }, [order?.pickupDate]);
  ...
  return (
    <main className="track-page">
        ...
        <section className="track-grid">
          <article className="track-info-card">
            ...
            <div className="track-mini-stats">
              <div>
                ...
                <strong>{formatIndianDateTime(order.pickupDate)}</strong>
              </div>
              <div>
                <span>Time Slot</span>
          ...
          <article className="track-info-card">
            ...
            <div className="summary-list">
              ...
              <div>
                <span>□</span>
                <p><b>Scheduled Slot</b><br />{formatIndianDateTime(order.pickupDate)} · {order.startRange || "-"} - {order.endRange || "-"}</p>
              </div>
              <div>
                <span>♻</span>
      ...
      <PublicFooter className="track-footer" copybarClassName="track-copybar" showAddress={false} />
    </main>
  );
};
